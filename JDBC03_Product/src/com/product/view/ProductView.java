...
public class ProductView {
	...
	public static int getMenu() {
	 ...
	 public static void main(String[] args) {
		   /*
	       MVC 패턴 1 : Controller + View가 합쳐져서 하나의 형태가 된 것(Member)
	       MVC 패턴 2 : Controller, View가 분리된 형태가 된 것(지금. Product)
	       * */
	      int select = 0;
	      // 뷰에서는 컨트롤러로 호출
	      ...
	      while(select!=6) {
	         ...
	         case 3:
	            // 제품추가
	            System.out.println("추가 할 제품의 정보를 입력해 주세요.");
